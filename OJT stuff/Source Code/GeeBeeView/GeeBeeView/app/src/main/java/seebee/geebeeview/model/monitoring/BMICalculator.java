...
public class BMICalculator {
    ...
    public static String getBMIResultString(boolean isGirl, int age, int height, int weight) {
        float patientBMI = computeBMIMetric(height, weight);
        return getBMIResultString(isGirl, age, patientBMI);
    }
}
